...
class FGMembersite
{
    ...
    function Login()
    {
        ...
        if(!isset($_SESSION)){ session_set_cookie_params(0, '/', '.drewpost.net'); session_start(); }
...
if ($result->num_rows > 0) {
    ...
    function LogOut()
    {
        session_set_cookie_params(0, '/', '.drewpost.net');
        session_start();
